...
func (f *File) Seek(offset int64, whence int) (int64, error) {
	...
	case 0:
		// origin
		off = offset
		if f.fid.Qid.Type&ninep.QTDIR > 0 && off != 0 {
			return 0, Eisdir
		}

	case 1:
		// current
		if f.fid.Qid.Type&ninep.QTDIR > 0 {
			return 0, Eisdir
		}
	...
	case 2:
		...
		if err != nil {
			return 0, &ninep.Error{"stat error in seek: " + err.Error(), ninep.EIO}
		}
		off = int64(dir.Length) + offset

	default:
		return 0, &ninep.Error{"bad whence in seek", ninep.EIO}
	}
